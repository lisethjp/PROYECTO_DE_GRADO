...
RUTA_DATOS = Path(
    r"C:\Users\arlin\OneDrive\Imágenes\SALP_Bucaramanga\Prediccion 3 meses - Copy\data_clean"
)

RUTA_SALIDA = Path(
    r"C:\Users\arlin\OneDrive\Imágenes\SALP_Bucaramanga\Prediccion 3 meses - Copy"
)

RUTA_SALIDA.mkdir(exist_ok=True)

ARCHIVO_ENTRADA = RUTA_DATOS / "salp_consumo_2022_2025_ordenado.xlsx"
ARCHIVO_SALIDA = RUTA_SALIDA / "pronostico_enero2025_junio2025.xlsx"
...
for cuenta in cuentas:
    ...
    try:
        ...
        # Calcular pasos necesarios hasta junio 2025
        ...
        # Filtrar solo enero 2025 – junio 2025
        df_temp = df_temp[
