# ============================================================
# PREDICCIÓN ARIMA OPTIMIZADO – ENERO 2025 A JUNIO 2025
# ============================================================
...
RUTA_DATOS = Path(
    r"C:\Users\arlin\OneDrive\Imágenes\SALP_Bucaramanga\SEGUNDO ENTRENAMIENTO\Prediccion 6 meses\data_clean"
)

RUTA_SALIDA = RUTA_DATOS.parent

ARCHIVO_ENTRADA = RUTA_DATOS / "salp_consumo_2022_2025_ordenado.xlsx"
ARCHIVO_SALIDA = RUTA_SALIDA / "pronostico_ARIMA_enero2025_junio2025.xlsx"
...
# ------------------------------------------------------------
# 3. RANGO A PRONOSTICAR (ENERO – JUNIO 2025)
# ------------------------------------------------------------
