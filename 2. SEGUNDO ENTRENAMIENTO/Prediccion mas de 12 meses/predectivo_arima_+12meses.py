# ============================================================
# PREDICCIÓN ARIMA OPTIMIZADO – ABRIL 2024 A JUNIO 2025
# ============================================================
...
RUTA_DATOS = Path(
    r"C:\Users\arlin\OneDrive\Imágenes\SALP_Bucaramanga\SEGUNDO ENTRENAMIENTO\Prediccion mas de 12 meses\data_clean"
)

RUTA_SALIDA = RUTA_DATOS.parent

ARCHIVO_ENTRADA = RUTA_DATOS / "salp_consumo_2022_2025_ordenado.xlsx"
ARCHIVO_SALIDA = RUTA_SALIDA / "pronostico_ARIMA_abril2024_junio2025.xlsx"
...
# ------------------------------------------------------------
# 3. RANGO A PRONOSTICAR (ABRIL 2024 – JUNIO 2025)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 4. FUNCIÓN PARA SELECCIONAR MEJOR ARIMA POR AIC
# ------------------------------------------------------------
...
print("\n✅ PROCESO COMPLETADO (ABRIL 2024 – JUNIO 2025)")
